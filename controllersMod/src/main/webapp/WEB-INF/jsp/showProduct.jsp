			...
			<div class="product">
				...
				<div style="clear:both; text-align:right;"><a href="product/edit/${product.id}"><spring:message code="showProduct.edit"/></a> <a href="product/delete/${product.id}"><spring:message code="showProduct.delete"/></a></div>
			</div>